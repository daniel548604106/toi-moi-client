...
import { DotsHorizontalIcon, UserIcon, PlusIcon } from '@heroicons/react/outline';
    ...
    <div>
        ...
        <div className="px-10 py-16 sm:py-20 bg-secondary text-secondary border-b">
          <div className="absolute bottom-[50px] left-[30px] flex items-end ">
            ...
            <div className="ml-[20px]">
              <h2 className="text-2xl sm:text-4xl font-semibold">{user.name}</h2>
      ...
      <div className="p-3  bg-secondary text-secondary border-t flex item-center justify-between">
        <ul className="text-sm sm:text-md hidden sm:flex items-center text-gray-600 space-x-1 md:space-x-3">
          <li className="cursor-pointer p-2 px-2 md:px-4 rounded-lg hover:bg-gray-100">Homepage</li>
          <li className="cursor-pointer p-2 px-2 md:px-4 rounded-lg hover:bg-gray-100">Photo</li>
          <li className="cursor-pointer p-2 px-2 md:px-4 rounded-lg hover:bg-gray-100 ">About</li>
        </ul>
